...
public class RetryTestBean {
    ...
    @Retry(retryOn = BulkheadException.class, delay = 300)
    @Bulkhead(2)
    @Fallback(fallbackMethod = "fallback")
    public String callWithRetryOnBulkhead() {
        ...
        // the third attempt should be retried in 200 ms, after the first two calls were processed and should be successful
    ...
    @Retry(retryOn = TimeoutException.class, delay = 300)
    @Bulkhead(2)
